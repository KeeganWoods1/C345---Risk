...
// abstract class parent class, no algorithm so for this class all comments are in Order.h
	...
	istream& operator >> (istream& stream, Advanceorder& o) {

	}
	ostream& operator << (ostream& out, const Advanceorder& o) {
	...
	istream& operator >> (istream& stream, airliftorder& o) {

	}
	ostream& operator << (ostream& out, const airliftorder& o) {
	...
	istream& operator >> (istream& stream, Blockadeorder& o) {
	...
	istream& operator >> (istream& stream, Bomborder& o) {
	...
	istream& operator >> (istream& stream, Deployorder& o) {
	...
	istream& operator >> (istream& stream, Negotiateorder& o) {
	...
	istream& operator >> (istream& stream, Reinforcementorder& o) {
